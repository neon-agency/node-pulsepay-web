...
rechargeOrdersRoutes.patch('/:id/items/:itemId/execution', authMiddleware, asyncHandler((req, res) => rechargeOrdersController.setItemExecution(req, res)));
rechargeOrdersRoutes.patch('/:id/status', authMiddleware, asyncHandler((req, res) => rechargeOrdersController.transitionStatus(req, res)));
...
rechargeOrdersRoutes.delete('/:id', authMiddleware, asyncHandler((req, res) => rechargeOrdersController.delete(req, res)));
