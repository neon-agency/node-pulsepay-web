...
rechargeRequestsRoutes.get('/pending-count', authMiddleware, asyncHandler((req, res) => rechargeRequestsController.pendingCount(req, res)));
...
rechargeRequestsRoutes.get('/:id/whatsapp-fallback', authMiddleware, asyncHandler((req, res) => rechargeRequestsController.whatsappFallback(req, res)));
...
rechargeRequestsRoutes.delete('/:id', authMiddleware, asyncHandler((req, res) => rechargeRequestsController.delete(req, res)));
